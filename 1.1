...
E, A: Use Duke’s 7 steps and include a description on how you broke the problem into sub-problems.
  ...
  Step 5: Translate to Code
    if(str.length() > 255) return false; //chars are 1 bit
...
what you learned
  thought of problem and requirments that show true, realized innate rules of programming languages, ran ideas though tested them
